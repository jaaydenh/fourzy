namespace FourzyGameModel.Model
{
    ...
    public class RightBotAI : AIPlayer
    {
        ...
        public RightBotAI(GameState State)
        {
        ...
        public PlayerTurn GetTurn()
        {
            ...
            AITurnEvaluator AI = new AITurnEvaluator(EvalState, TE.GetAvailableSimpleMoves(Direction.RIGHT));
