...
{
    public class SproutToken : IToken
    {
        ...
        public string Notation
        {
            get
            {
                return TokenConstants.Sprout.ToString();
            }
        }
        ...
        public List<string> ExportNotation
        {
            get
            {
                return new List<string>() { TokenConstants.Sprout.ToString() };
            }
        }
