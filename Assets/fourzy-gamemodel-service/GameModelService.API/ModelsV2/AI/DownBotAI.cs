namespace FourzyGameModel.Model
{
    ...
    public class DownBotAI : AIPlayer
    {
        ...
        public DownBotAI(GameState State)
        {
        ...
        public PlayerTurn GetTurn()
        {
            ...
            AITurnEvaluator AI = new AITurnEvaluator(EvalState, TE.GetAvailableSimpleMoves(Direction.DOWN));
