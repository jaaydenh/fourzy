...
namespace FourzyGameModel.Model
{
    public class FourzyGame
    {
        ...
        public FourzyGame(Player Player1, Player Player2, GameOptions Options = null, BoardGenerationPreferences Preferences = null)
        {
            ...
            GameBoard Board = BoardFactory.CreateGameBoard(Area.NONE, Options, Preferences);
        ...
        public FourzyGame(Area Area, AIProfile Profile, Player Player, int FirstPlayerId = 1, GameOptions Options = null)
        {
            ...
            GameBoard Board = BoardFactory.CreateGameBoard(Area, Options);
            this.State = new GameState(Board, Options, FirstPlayerId);
        ...
        public virtual PlayerTurnResult TakeTurn(PlayerTurn Turn, bool ReturnStartOfNextTurn =false, bool TriggerEndOfTurn = true)
        {
            ...
            State = ME.EvaluateTurn(Turn, false, true, TriggerEndOfTurn);
