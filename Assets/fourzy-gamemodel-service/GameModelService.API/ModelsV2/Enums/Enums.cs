namespace FourzyGameModel.Model
{
    ...
    public enum GameActionType { INVALID, ADD_PIECE, MOVE_PIECE, BUMP, PUSH, ADD_TOKEN, GAME_END, COLLECT, DESTROY, SPELL, STOP, TRANSITION, EFFECT, REMOVE_TOKEN, BOSS_POWER    }
    public enum GameActionTiming { BEFORE_MOVE, MOVE, AFTER_MOVE}
    public enum InvalidTurnType { BLOCKED, NOMOREPIECES, WRONGPLAYER, BADPLAYERID}
    public enum GameEndType { WIN, DRAW}
