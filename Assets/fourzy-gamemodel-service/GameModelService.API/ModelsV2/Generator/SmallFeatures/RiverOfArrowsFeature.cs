...
{
    public class RiverOfArrowsFeature : ISmallFeature, IBoardIngredient
    {
        ...
        public SmallFeatureType Feature { get { return SmallFeatureType.RIVER_OF_ARROWS; } }
        public Direction FirstDirection { get; set; }
    
        public AddTokenMethod AddMethod { get; set; }
        public bool ReplaceTokens { get; set; }

        public RiverOfArrowsFeature(Direction FirstDirection = Direction.RANDOM, AddTokenMethod AddMethod = AddTokenMethod.ONLY_TERRAIN, bool ReplaceTokens = false)
        {
            this.FirstDirection = FirstDirection;
            this.Name = "River Of Arrows" + " " + FirstDirection.ToString();
