...
namespace FourzyGameModel.Model
{
    ...
    /// </summary>
    public class ShineGameEffect : IGameEffect
    {
        //Interface
        ...
        public ShineGameEffect(int Duration, GameState Parent = null)
        {
            this.Name = "Shine";
            this.Type = GameEffectType.SHINE;
        ...
        public ShineGameEffect(string Notation)
        {
            this.Name = "Shine";
            this.Type = GameEffectType.SHINE;
            this.Timing = GameEffectTiming.PASSIVE;
