...
{
    public class MagicArrowToken : IToken
    {
        ...
        public MagicArrowToken(Direction Orientation, int MagicAdjustment = TokenConstants.DefaultMagicArrowGain)
        {
            StandardTokenInit();
        ...
        public MagicArrowToken(string notation)
        {
            StandardTokenInit();
