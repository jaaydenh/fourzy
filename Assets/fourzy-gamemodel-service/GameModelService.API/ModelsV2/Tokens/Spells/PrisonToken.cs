...
{
    public class PrisonToken : IToken
    {
        ...
        public string Notation
        {
            get
            {
                return TokenConstants.Prison.ToString() + "," + PlayerId + "," + Countdown;
            }
        }
        ...
        public List<string> ExportNotation
        {
            get
            {
                return new List<string>() { TokenConstants.Prison.ToString() + ',' + PlayerId.ToString() + ',' + Countdown.ToString() };
            }
        }
        ...
        public PrisonToken(int PlayerId, int Duration = SpellConstants.DefaultPrisonDuration)
        {
            StandardTokenInit();
            this.PlayerId = PlayerId;
            this.Countdown = Duration;

            this.Type = TokenType.PRISON;
        }

        public PrisonToken(string Notation)
        {
            StandardTokenInit();
            this.PlayerId = 0;
            this.Countdown = 4;
        ...
        public void Fade()
        {
            ...
            Space.RemoveTokens(TokenType.PRISON);
        }
