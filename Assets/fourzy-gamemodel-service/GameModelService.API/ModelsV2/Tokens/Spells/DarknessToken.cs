...
{
    public class DarknessToken : IToken
    {
        ...
        public char TokenCharacter
        {
            get
            {
                return TokenConstants.Darkness;
            }
        }
        ...
        public string Notation
        {
            get
            {
                return TokenConstants.Darkness.ToString() + "," + PlayerId + "," + Countdown;
            }
        }
        ...
        public List<string> ExportNotation
        {
            get
            {
                return new List<string>() { TokenConstants.Darkness.ToString() + ',' + PlayerId.ToString() + ',' + Countdown.ToString() };
            }
        }
        ...
        public DarknessToken(int PlayerId, int Duration = SpellConstants.DefaultDarknessDuration)
        {
            StandardTokenInit();
        ...
        public DarknessToken(string Notation)
        {
            StandardTokenInit();
            this.PlayerId = 0;
            this.Countdown = 4;
        ...
        public void Fade()
        {
            ...
            Space.RemoveTokens(TokenType.DARKNESS);
        }
