...
{
    public class HexSpellToken : IToken
    {
        ...
        public string Notation
        {
            get
            {
                return TokenConstants.Hex.ToString() + "," + PlayerId + "," + Countdown;
            }
        }
        ...
        public List<string> ExportNotation
        {
            get
            {
                return new List<string>() { TokenConstants.Hex.ToString() + ',' + PlayerId.ToString() + ',' + Countdown.ToString() };
            }
        }
        ...
        public HexSpellToken(int PlayerId, int Duration = SpellConstants.DefaultHexDuration)
        {
            ...
            this.Type = TokenType.HEX;
            this.pieceCanEndMoveOn = false;
            this.adjustMomentum = 0;
        }

        public HexSpellToken(string Notation)
        {
            StandardTokenInit();
            this.PlayerId = 0;
            this.Countdown = 4;
