...
{
    public class FourWayRandomArrowToken : IToken
    {
        ...
        public List<string> ExportNotation
        {
            get
            {
                return new List<string>() { TokenConstants.RandomFourWay.ToString() };
            }
        }
        ...
        public FourWayRandomArrowToken()
        {
            StandardTokenInit();
        ...
        {
            return (Space.Random.RandomDirection());
        }
