...
namespace FourzyGameModel.Model
{
    public class FireToken : IToken
    {
        ...
        public List<string> ExportNotation
        {
            get
            {
                return new List<string>() { TokenConstants.Fire.ToString() };
            }
        }
        ...
        public void EndOfTurn(int PlayerId)
        {
            ...
            {
                Space.Parent.RecordGameAction(new GameActionDestroyed(Space.ActivePiece, Space.Location, DestroyType.BURNING));
                Space.Pieces.Clear();
            }
        }
        ...
        {
            if (Piece.Location.Equals(Space.Location)) Piece.Piece.Conditions.Add(PieceConditionType.FIERY);
        }
