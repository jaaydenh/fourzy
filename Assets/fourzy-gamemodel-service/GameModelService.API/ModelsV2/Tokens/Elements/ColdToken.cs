...
namespace FourzyGameModel.Model
{
    public class ColdToken : IToken
    {
        ...
        public List<string> ExportNotation
        {
            get
            {
                return new List<string>() { TokenConstants.Cold.ToString() };
            }
        }
        ...
        {
            if (Piece.Location.Equals(Space.Location)) Piece.Piece.Conditions.Add(PieceConditionType.FROZEN);
        }
