...
{
    public class PreIceToken : IToken
    {
        ...
        public string Notation
        {
            get
            {
                return TokenConstants.PreIce.ToString();
            }
        }
        ...
        public List<string> ExportNotation
        {
            get
            {
                return new List<string>() { TokenConstants.PreIce.ToString() };
            }
        }
        ...
        public PreIceToken(int Countdown = TokenConstants.DefaultCountdown)
        {
            StandardTokenInit();

            this.Type = TokenType.PRE_ICE;
