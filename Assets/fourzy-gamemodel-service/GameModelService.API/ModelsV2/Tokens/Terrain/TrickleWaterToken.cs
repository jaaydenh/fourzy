...
{
    public class TrickleWaterToken : IToken
    {
        ...
        public char TokenCharacter
        {
            get
            {
                return TokenConstants.TrickleWater;
            }
        }
        ...
        public string Notation
        {
            get
            {
                return TokenConstants.TrickleWater.ToString();
            }
        }
        ...
        public List<string> ExportNotation
        {
            get
            {
                return new List<string>() { TokenConstants.TrickleWater.ToString() };
            }
        }
        ...
        public TrickleWaterToken()
        {
            StandardTokenInit();

            this.Type = TokenType.TRICKLEWATER;
        }
