...
{
    public class PreGoopToken : IToken
    {
        ...
        public string Notation
        {
            get
            {
                return TokenConstants.PreGoop.ToString();
            }
        }
        ...
        public List<string> ExportNotation
        {
            get
            {
                return new List<string>() { TokenConstants.PreGoop.ToString() };
            }
        }
        ...
        public PreGoopToken(int Countdown = TokenConstants.DefaultCountdown)
        {
            StandardTokenInit();

            this.Type = TokenType.PRE_GOOP;
