...
{
    public class ArrowToken : IToken
    {
        ...
        public char TokenCharacter { get
            {
        ...
        public ArrowToken(Direction Orientation)
        {
            StandardTokenInit();
        ...
        public ArrowToken(string Notation)
        {
            StandardTokenInit();
        ...
        {
            if (Space.ContainsPiece) Active = false;
            else Active = true;
        }
