...
{
    public class MovingSunToken : IToken
    {
        ...
        public char TokenCharacter
        {
            get
            {
                return TokenConstants.MovingSun;
            }
        }
        ...
        public List<string> ExportNotation
        {
            get
            {
                return new List<string>() { TokenConstants.MovingSun.ToString() };
            }
        }
        ...
        public MovingSunToken(Direction Orientation)
        {
            StandardTokenInit();

            this.Type = TokenType.MOVING_SUN;
        ...
        public MovingSunToken(string Notation)
        {
            StandardTokenInit();
