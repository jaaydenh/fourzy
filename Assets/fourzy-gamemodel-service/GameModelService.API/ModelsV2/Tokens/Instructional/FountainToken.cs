...
{
    public class FountainToken : IToken
    {
        ...
        public char TokenCharacter
        {
            get
            {
                return TokenConstants.Fountain;
            }
        }
        ...
        public List<string> ExportNotation
        {
            get
            {
                return new List<string>() { TokenConstants.Fountain.ToString() };
            }
        }
        ...
        public void PieceBumpsIntoLocation(MovingPiece Piece, BoardLocation Location)
        {
            ...
            {
                BoardSpace Target = Space.Parent.ContentsAt(Piece.Location.Neighbor(Piece.Direction));
                if (!Target.ContainsTokenType(TokenType.WATER))
                {
                    Target.AddToken(new WaterToken());
                }
            }
        }
