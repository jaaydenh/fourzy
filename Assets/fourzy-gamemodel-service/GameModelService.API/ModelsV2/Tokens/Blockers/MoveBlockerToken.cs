...
{
    public class MoveBlockerToken : IToken
    {
        ...
        public char TokenCharacter
        {
            get
            {
                return TokenConstants.MoveBlocker;
            }
        }
        ...
        public List<string> ExportNotation
        {
            get
            {
                return new List<string>() { TokenConstants.MoveBlocker.ToString() };
            }
        }
        ...
        public MoveBlockerToken()
        {

            StandardTokenInit();

            this.Type = TokenType.MOVE_BLOCKER;
