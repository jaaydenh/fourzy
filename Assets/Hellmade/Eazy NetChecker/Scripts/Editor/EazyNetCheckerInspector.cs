...
namespace Hellmade.Net
{
    ...
    public class EazyNetCheckerInspector : Editor
    {
        ...
        private void SetupStyles()
        {
            ...
            // Full Width Button 1 
            fullWidthButton1 = new GUIStyle(GUI.skin.GetStyle("PreButton"));
            ...
            groupBox1Style.normal.background = Resources.Load("Groupbox1Background_Hellmade") as Texture2D;
        ...
        public override void OnInspectorGUI()
        {
            ...
            // Check interval
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField(new GUIContent("Check Interval", "How often an internet check will be performed (if a continuous check is started)"), GUILayout.Width(160));
            EazyNetChecker.CheckInterval = EditorGUILayout.FloatField(EazyNetChecker.CheckInterval, GUILayout.Width(50));
