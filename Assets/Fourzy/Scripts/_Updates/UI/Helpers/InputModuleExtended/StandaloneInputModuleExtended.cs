...
namespace UnityEngine.EventSystems
{
    ...
    /// </remarks>
    public class StandaloneInputModuleExtended : PointerInputModuleExtended
    {
        public static StandaloneInputModuleExtended instance;

        public static float MOVE_SPEED_SCALE = 1f;
        public static float HOVERED_MOVE_SPEED_SCALE = .3f;
        ...
        public static int GamepadID
        {
            ...
            set
            {
                if (gamepadID != value)
                {
                    //check last virtualPointerState
                    if (instance.lastVirtualPointerState == VirtualPointerState.PRESSED) instance.SetVirtualPointerState(VirtualPointerState.RELEASED);
                }

                gamepadID = value;

                onGamepadIDChanged?.Invoke(gamepadID);
            }
        }

        public static GamepadControlFilter GamepadFilter
        {
            get => gamepadFilter;
            ...
            set
            {
                ...
                onFilterChanged?.Invoke(gamepadFilter);
            }
        }
        ...
        private Vector2 lastJoystick1;
        private Vector2 lastJoystick2;
        ...
        protected override void Awake()
        {
            ...
            instance = this;
            moveSpeed = (Screen.width + Screen.height) * .5f * MOVE_SPEED_SCALE;
        ...
        public static KeyCode GetKeyCode(int button, int jIndex)
        {
            ...
            switch (jIndex)
            {
                case 0:
                    ...
                    {
                        case 0:
                            if (CheckKey(KeyCode.LeftShift)) return KeyCode.LeftShift;
                            else
                            {
                                if (IsXBoxGamepad(jNames, jIndex))
                        ...
                        case 1:
                            if (CheckKey(KeyCode.Z)) return KeyCode.Z;
                            else
                            {
                                if (IsXBoxGamepad(jNames, jIndex))
                                    return KeyCode.Joystick1Button1;
                        ...
                        case 2:
                            if (CheckKey(KeyCode.LeftControl)) return KeyCode.LeftControl;
                            else
                            {
                                if (IsXBoxGamepad(jNames, jIndex))
                                    return KeyCode.Joystick1Button2;
                        ...
                        case 3:
                            if (CheckKey(KeyCode.LeftAlt)) return KeyCode.LeftAlt;
                            else
                            {
                                if (IsXBoxGamepad(jNames, jIndex))
                ...
                case 1:
                    ...
                    {
                        case 0:
                            if (CheckKey(KeyCode.W)) return KeyCode.W;
                            else
                            {
                                if (IsXBoxGamepad(jNames, jIndex))
                        ...
                        case 1:
                            if (CheckKey(KeyCode.E)) return KeyCode.E;
                            else
                            {
                                if (IsXBoxGamepad(jNames, jIndex))
                                    return KeyCode.Joystick2Button1;
                        ...
                        case 2:
                            if (CheckKey(KeyCode.A)) return KeyCode.A;
                            else
                            {
                                if (IsXBoxGamepad(jNames, jIndex))
                                    return KeyCode.Joystick2Button2;
                        ...
                        case 3:
                            if (CheckKey(KeyCode.S)) return KeyCode.S;
                            else
                            {
                                if (IsXBoxGamepad(jNames, jIndex))
        ...
        protected StandaloneInputModuleExtended()
        {
        }
        ...
        private bool ProcessTouchEvents()
        {
            ...
            if (input.touchCount > 0) ResetNoInputTimer();
