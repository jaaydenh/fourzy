...
namespace Fourzy
{
    public static class Constants
    {
        ...
        public const int SKILLZ_WIN_POINTS = 1000;
        public const int SKILLZ_DRAW_POINTS = 500;
        ...
        public const int SKILLZ_GAME_COMPLEXITY_LOW = 300;
        public const int SKILLZ_GAME_COMPLEXITY_HIGH = 700;
