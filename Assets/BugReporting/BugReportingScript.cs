...
public class BugReportingScript : MonoBehaviour
{
    ...
    public void CreateBugReport()
    {
        ...
        UnityBugReporting.CurrentClient.CreateBugReport((br) =>
        {
            ...
            br.Attachments.Add(new BugReportAttachment("Sample Attachment", "SampleAttachment.txt", "text/plain", System.Text.Encoding.UTF8.GetBytes("This is a sample attachment.")));
